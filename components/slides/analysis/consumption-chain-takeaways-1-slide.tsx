  ...
  return (
    <div className="p-8 pb-24 max-w-6xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-lg font-semibold text-blue-500 mt-0.5">{consumptionChainTakeaways1.category}</p>
      </div>
      ...
      <div className="space-y-2">
        {consumptionChainTakeaways1.takeaways.map((takeaway, idx) => (
          <div
            key={idx}
            className={`animate-fade-up stagger-${idx + 1} p-3 rounded-lg bg-card border-2 border-blue-500`}
          >
