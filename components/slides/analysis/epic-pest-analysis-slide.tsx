  ...
  return (
    <div className="px-12 pt-8 pb-20 h-full flex flex-col">
      <div className="mb-8">
        ...
        <h2 className="text-5xl font-bold mt-4 tracking-tight text-foreground">EPIC PEST Analysis</h2>
        <p className="text-muted-foreground mt-0.5 text-xl">External macro-environmental factors shaping the CGM industry</p>
      </div>
            ...
            >
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-bold text-foreground mb-0.5">{factor.title}</h3>
                  <p className="text-muted-foreground leading-tight text-xl">{factor.content}</p>
                </div>
              </div>
            </div>
          )
      ...
      <div className="animate-fade-up stagger-5 mt-4 p-5 rounded-lg bg-gradient-to-br from-pink-500/20 to-pink-500/5 border-2 border-pink-500">
        <div className="flex items-start gap-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-tight text-xl">
