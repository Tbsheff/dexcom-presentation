  ...
  return (
    <div className="p-12 pb-28 max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <h2 className="text-5xl font-bold mt-2 tracking-tight text-foreground">Operating Margins</h2>
        <p className="text-muted-foreground mt-2">Profitability comparison across the industry</p>
      </div>
      ...
      <div className="space-y-8">
        ...
        {/* Detailed Comparison */}
        <div className="animate-fade-up stagger-3 grid grid-cols-2 gap-6 mt-12">
        ...
        {/* Key Insight */}
        <div className="animate-fade-up stagger-4 p-6 rounded-lg bg-primary/10 border border-primary/30">
