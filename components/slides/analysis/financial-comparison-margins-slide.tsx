  ...
  return (
    <div className="p-10 pb-24 max-w-6xl mx-auto">
      <div className="mb-4">
        ...
        <p className="text-muted-foreground mt-1">Profitability comparison across the industry</p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="animate-fade-up stagger-1">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-xl font-bold text-foreground">Industry Average</h3>
          </div>
          <div className="relative h-16 bg-muted rounded-lg overflow-hidden">
            <div
              className="absolute inset-y-0 left-0 bg-gradient-to-r from-blue-500 to-blue-400 flex items-center justify-end pr-4"
              style={{ width: `${industryAvg}%` }}
            >
              <span className="text-2xl font-bold text-white">{industryAvg}%</span>
            </div>
          </div>
        ...
        <div className="animate-fade-up stagger-2">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-xl font-bold text-foreground">Dexcom</h3>
          </div>
          <div className="relative h-16 bg-muted rounded-lg overflow-hidden">
            <div
              className="absolute inset-y-0 left-0 bg-gradient-to-r from-primary to-primary/80 flex items-center justify-end pr-4"
              style={{ width: `${dexcomMargin}%` }}
            >
              <span className="text-2xl font-bold text-white">{dexcomMargin}%</span>
            </div>
          </div>
          <p className="text-sm text-muted-foreground mt-1.5">
        ...
        {/* Detailed Comparison */}
        <div className="animate-fade-up stagger-3 grid grid-cols-2 gap-3 mt-2">
        ...
        {/* Key Insight */}
        <div className="animate-fade-up stagger-4 p-3 rounded-lg bg-primary/10 border border-primary/30">
