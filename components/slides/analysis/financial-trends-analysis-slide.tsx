  ...
  return (
    <div className="p-16 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="animate-fade-up stagger-1 p-6 rounded-lg bg-card border-l-4 border-l-blue">
        ...
        <div className="animate-fade-up stagger-2 p-6 rounded-lg bg-card border-l-4 border-l-sage">
        ...
        <div className="animate-fade-up stagger-3 p-6 rounded-lg bg-card border-l-4 border-l-coral">
