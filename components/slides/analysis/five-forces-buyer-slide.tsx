  ...
  return (
    <div className="px-12 pt-8 pb-20 h-full flex flex-col">
      <div className="mb-8">
        ...
        <h2 className="text-5xl font-bold mt-4 tracking-tight text-foreground">Buyer Power</h2>
        <p className="text-muted-foreground mt-4 text-2xl">Bargaining power of customers and payers</p>
      </div>
            ...
            <div className="flex items-center gap-5 mb-8">
              ...
              <div>
                ...
                <div className="flex items-center gap-5 mt-0.5">
                  <span className={`px-2 py-0.5 rounded-full text-white text-xl font-bold ${getRatingColor(buyer.rating)}`}>
                    {buyer.rating}
                  </span>
                </div>
              </div>
