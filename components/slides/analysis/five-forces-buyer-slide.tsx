  ...
  return (
    <div className="p-6 pb-20 max-w-6xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-2 text-sm">Bargaining power of customers and payers</p>
      </div>
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  <span className={`px-2 py-0.5 rounded-full text-white text-xs font-bold ${getRatingColor(buyer.rating)}`}>
                    {buyer.rating}
                  </span>
                </div>
              </div>
