  ...
  return (
    <div className="p-12 pb-28 max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">Barriers to entry and likelihood of new competitors</p>
      </div>
      ...
      <div className="flex gap-8">
        <div className="flex-1 space-y-6">
          {newEntry.points.map((point, idx) => (
            <div
              key={idx}
              className={`animate-fade-up stagger-${idx + 1} p-6 rounded-lg bg-card border-l-4 border-l-green-500`}
            >
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span className={`px-3 py-1 rounded-full text-white text-sm font-bold ${getRatingColor(newEntry.rating)}`}>
                    {newEntry.rating}
                  </span>
                </div>
              </div>
