  ...
  return (
    <div className="px-12 pt-8 pb-20 h-full flex flex-col">
      <div className="mb-8">
        ...
        <h2 className="text-5xl font-bold mt-4 tracking-tight text-foreground leading-tight">Imitation Barriers Created</h2>
        <p className="text-muted-foreground mt-0.5 text-xl leading-tight">Defensive moats Dexcom has built to protect competitive advantage</p>
      </div>
      ...
      <div className="space-y-6 flex-1">
        {barriers.map((barrier, idx) => (
          <div
            key={idx}
            className={`animate-fade-up stagger-${idx + 1} p-5 rounded-lg bg-card border border-primary/20`}
          >
