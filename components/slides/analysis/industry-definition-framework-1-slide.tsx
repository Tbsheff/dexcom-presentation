  ...
  return (
    <div className="p-10 pb-24 max-w-6xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-2 text-sm">Core business classification and scope</p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        {/* NAICS Code Column */}
        <div className="animate-fade-up stagger-3 p-4 rounded-lg bg-card border border-primary/50">
          <div className="flex items-center gap-3 mb-3">
            <div className="p-2 rounded-lg bg-primary/10">
