  ...
  return (
    <div className="p-10 pb-24 max-w-6xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-2 text-sm">Customer needs and target markets</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="animate-fade-up stagger-2">
          ...
          <div className="p-4 rounded-lg bg-card border border-border h-[calc(100%-3rem)]">
