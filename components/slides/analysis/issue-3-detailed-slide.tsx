  ...
  return (
    <div className="p-10 pb-24 max-w-6xl mx-auto">
      <div className="mb-6">
        ...
        <h2 className="text-5xl font-bold mt-2 tracking-tight text-foreground">Issue #3</h2>
        <p className="text-muted-foreground mt-2 text-lg font-medium">{recommendationsSection07.issue3.title}</p>
      </div>

      <div className="space-y-3">
        {/* Issue Points */}
        {recommendationsSection07.issue3.points.map((point, idx) => (
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1 text-sm">
                Loss of physician advocacy threatens Dexcom's prescription-dependent business model
              </p>
            </div>
          </div>
        </div>
