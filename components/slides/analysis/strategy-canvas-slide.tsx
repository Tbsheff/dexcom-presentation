...
export function StrategyCanvasSlide() {
  return (
    <div className="p-10 pb-24 max-w-6xl mx-auto">
      ...
      <div className="animate-fade-up p-6 rounded-lg bg-card border border-border mb-4">
        <ResponsiveContainer width="100%" height={400}>
          <LineChart data={strategyCanvasData} margin={{ top: 20, right: 30, bottom: 20, left: 10 }}>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="animate-fade-up stagger-1 p-4 rounded-lg bg-card border-l-4 border-l-primary">
          <h4 className="font-bold text-foreground mb-2">Dexcom's Strengths</h4>
          <p className="text-sm text-muted-foreground">
            Leads in Accuracy (95) and Integration (100), with strong Calibration convenience (no fingersticks required)
          </p>
        </div>

        <div className="animate-fade-up stagger-2 p-4 rounded-lg bg-card border-l-4 border-l-amber">
          <h4 className="font-bold text-foreground mb-2">Competitive Positioning</h4>
          <p className="text-sm text-muted-foreground">
        ...
        <div className="animate-fade-up stagger-3 p-4 rounded-lg bg-card border-l-4 border-l-blue">
